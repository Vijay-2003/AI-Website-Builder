...
import { FolderTreeIcon, MessageSquareIcon, Recycle } from 'lucide-react';
...
const BuilderPage = () => {
  ...
  const { handleChat, chatLoading, activeProject, loadingActiveProject, activeFile, showCode, setActiveFile, setShowCode, loadProject, Logout } = useAppContext();
