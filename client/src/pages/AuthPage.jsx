    ...
    <div className=' min-h-screen bg-white flex text-zinc-900 font-sans'>
      ...
      <div className=' flex-1 flex items-center justify-center p-8'>
        <div className=' w-full max-w-sm'>
          ...
          {error && <div className=' mb-6 p-3 border border-red-200 bg-red-50 text-red-700 rounded'>{error}</div>}
          ...
          <form onSubmit={handleSubmit} className=' space-y-6'>
            ...
            <div>
              ...
              <input type='email' value={email} onChange={(e) => setEmail(e.target.value)} required className=' w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder-zinc-300 transition-colors' placeholder='JohnDoe@gmail.com' />
            </div>
